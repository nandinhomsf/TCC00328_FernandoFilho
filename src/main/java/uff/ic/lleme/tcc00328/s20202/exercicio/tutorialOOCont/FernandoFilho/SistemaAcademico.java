...
class SistemaAcademico {
    ...
    public static final Aluno[] aluno = new Aluno[5];
    public static final Disciplina[] disciplina = new Disciplina[5];
    public static final Turma[] turma = new Turma[5];
    public static final Inscricao[] inscricoes = new Inscricao[5];
    ...
    private static void carregarTurmas() throws IOException {
        InputStream input = new FileInputStream("src/main/java/uff/ic/lleme/tcc00328/s20202/exercicios/tutorialOOCont/FernandoFilho/Inscricao.txt");
        Scanner in = new Scanner(input);
        int i = 0;
        while (in.hasNext()) {
            turma[i] = new Turma();
